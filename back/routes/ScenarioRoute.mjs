...
scenarioRouter.post("/scenarios", requireAuth, validate(createScenarioSchema), createScenario);
...
scenarioRouter.post("/scenarios/:scenarioId/pages", requireAuth, validate(createPageSchema), createPage);
...
scenarioRouter.put("/scenarios/:scenarioId/positions", requireAuth, validate(updatePositionsSchema), updatePagePositions);
